...
echo "We are making ArchPK Bootable USB, please wait..."
echo "                               "
...
echo "                               "
echo "================================================================"
echo "Making ArchPK bootable USB, this may take sometime...."
cd out
sudo dd if=ArchPK-plasma-$(date +%Y.%m)-x86_64.iso of=/dev/sdb status='progress'
